...
def hausdorff(ellipse1, ellipse2):
    '''
    A distance metric for comparing the dissimilarity between two ellipses.
    In particular, calculate the Hausdorff Distance between the two shapes
    Parameters
    ----------
...
def single_frame_figure(path):
    ...
    pupil = xy[:-4]
    eye = xy[-4:]
    fig,ax_rows = plt.subplots(ncols = 3, nrows = 4, figsize = (6.66,6),
